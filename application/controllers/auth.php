...
class Auth extends CI_Controller {
	...
	function index()
	{
		...
		elseif($this->ion_auth->in_group('Supervisor')){
			$this->data['main_content'] ='frontend/Supervisor';
			$this->_render_page('includes/templates', $this->data);
		}

		elseif($this->ion_auth->in_group('Department_Admin')){
			$this->data['main_content'] ='frontend/Admin';
			$this->_render_page('includes/templates', $this->data);
		}

		elseif($this->ion_auth->in_group('Divition')){
			$this->data['main_content'] ='frontend/Divition';
			$this->_render_page('includes/templates', $this->data);
		}
		...
		elseif($this->ion_auth->in_group('Store_Keeper')){
			$this->data['main_content'] ='frontend/StoreKeeper';
			$this->_render_page('includes/templates', $this->data);
		}
